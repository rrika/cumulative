...
makefile.conf: 
	coq_makefile -R src Top -o makefile src/assignments.v src/cumulative.v src/definitions.v src/edge_finding.v src/misc.v src/theta_lambda_tree.v src/theta_tree.v
